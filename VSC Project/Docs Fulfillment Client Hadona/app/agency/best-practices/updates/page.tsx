...
export default function Page() {
  return (
    ...
    >
      ...
      <div className="my-6 space-y-6">
        <div className="rounded-lg border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
          ...
          <div className="space-y-2">
            <h4 className="font-semibold text-gray-900 dark:text-gray-100">New Features:</h4>
            ...
            <h4 className="mt-4 font-semibold text-gray-900 dark:text-gray-100">Improvements:</h4>
            <ul className="ml-4 list-disc space-y-1 text-sm text-gray-700 dark:text-gray-300">
              <li>Improved loading speed untuk dashboard (40% faster)</li>
              <li>Better mobile responsiveness</li>
              <li>Enhanced error messages dan user feedback</li>
            </ul>
            <h4 className="mt-4 font-semibold text-gray-900 dark:text-gray-100">Bug Fixes:</h4>
            <ul className="ml-4 list-disc space-y-1 text-sm text-gray-700 dark:text-gray-300">
        ...
        <div className="rounded-lg border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
          <div className="mb-3 flex items-center justify-between">
            ...
            <span className="rounded-full bg-orange-100 px-3 py-1 text-xs font-medium text-orange-800 dark:bg-orange-900/30 dark:text-orange-400">
              Important
            </span>
          </div>
          <div className="mb-3 flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400">
      ...
      <div className="my-6 space-y-4">
        <div className="rounded-lg border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-gray-900">
          <div className="mb-2 flex items-center justify-between">
            ...
            <span className="text-sm text-gray-500 dark:text-gray-400">28 November 2024</span>
          </div>
        ...
        <div className="rounded-lg border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-gray-900">
          <div className="mb-2 flex items-center justify-between">
            ...
            <span className="text-sm text-gray-500 dark:text-gray-400">15 November 2024</span>
          </div>
          <ul className="ml-4 list-disc space-y-1 text-sm text-gray-600 dark:text-gray-400">
        ...
        <div className="rounded-lg border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-gray-900">
          <div className="mb-2 flex items-center justify-between">
            ...
            <span className="text-sm text-gray-500 dark:text-gray-400">1 November 2024</span>
          </div>
          <ul className="ml-4 list-disc space-y-1 text-sm text-gray-600 dark:text-gray-400">
        ...
        <div className="rounded-lg border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-gray-900">
          <div className="mb-2 flex items-center justify-between">
            ...
            <span className="text-sm text-gray-500 dark:text-gray-400">20 Oktober 2024</span>
          </div>
          <ul className="ml-4 list-disc space-y-1 text-sm text-gray-600 dark:text-gray-400">
      ...
      <div className="my-6 space-y-4">
        <div className="rounded-lg border border-hadona-primary/20 bg-hadona-primary/5 p-5 dark:border-hadona-primary/30 dark:bg-hadona-primary/10">
          ...
          <span className="text-xs text-gray-500 dark:text-gray-400">Expected: Q1 2025</span>
        </div>
        ...
        <div className="rounded-lg border border-hadona-primary/20 bg-hadona-primary/5 p-5 dark:border-hadona-primary/30 dark:bg-hadona-primary/10">
          ...
          <span className="text-xs text-gray-500 dark:text-gray-400">Expected: Q2 2025</span>
        </div>
