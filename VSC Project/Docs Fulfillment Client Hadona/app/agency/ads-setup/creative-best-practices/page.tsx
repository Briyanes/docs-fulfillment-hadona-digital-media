    ...
    >
      ...
      <div className="my-6 space-y-4">
        <div className="rounded-lg border border-red-200 bg-red-50 p-4">
          <h3 className="mb-2 font-semibold text-red-800">Text Overlay Berlebihan</h3>
        ...
        <div className="rounded-lg border border-red-200 bg-red-50 p-4">
          <h3 className="mb-2 font-semibold text-red-800">Low Quality Creative</h3>
          <p className="text-sm text-red-700">
        ...
        <div className="rounded-lg border border-red-200 bg-red-50 p-4">
          <h3 className="mb-2 font-semibold text-red-800">Tidak Mobile-Optimized</h3>
          <p className="text-sm text-red-700">
        ...
        <div className="rounded-lg border border-red-200 bg-red-50 p-4">
          <h3 className="mb-2 font-semibold text-red-800">Copy yang Terlalu Sales-y</h3>
          <p className="text-sm text-red-700">
