    ...
    >
      ...
      <div className="my-8 grid gap-6 md:grid-cols-3">
        <div className="text-center">
          ...
          <div className="text-sm text-gray-600 dark:text-gray-400">Client Agency Aktif</div>
        </div>
        <div className="text-center">
          <div className="mb-2 text-4xl font-bold text-hadona-primary">99.9%</div>
          <div className="text-sm text-gray-600 dark:text-gray-400">Uptime Platform</div>
        </div>
        <div className="text-center">
      ...
      <div className="my-6 space-y-4">
        <div className="rounded-lg border-l-4 border-hadona-primary bg-gray-50 p-4 dark:bg-gray-900">
          <p className="mb-2 italic text-gray-700 dark:text-gray-300">
