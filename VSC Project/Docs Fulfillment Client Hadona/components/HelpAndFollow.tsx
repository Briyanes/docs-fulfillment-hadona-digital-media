  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8" style={{ backgroundColor: '#ffffff' }}>
      <div className="grid gap-6 md:grid-cols-10">
        ...
        {/* Follow Us Card - 70% */}
        <div className="rounded-lg border-2 border-red-500 bg-white p-6 shadow-sm md:col-span-7">
          ...
          <div className="flex flex-wrap gap-6">
            ...
            <div className="flex items-start gap-3 flex-1 min-w-[140px]">
              ...
              <div className="flex-1">
                <p className="font-semibold text-gray-900 text-sm">Social Media</p>
                <a
                  href="https://instagram.com/hadona.id"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-xs text-gray-600 hover:text-pink-600 transition-colors block"
                >
                  @hadona.id
                </a>
              </div>
            ...
            <div className="flex items-start gap-3 flex-1 min-w-[140px]">
              ...
              <div className="flex-1">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-xs text-gray-600 hover:text-blue-600 transition-colors block"
                >
            ...
            <div className="flex items-start gap-3 flex-1 min-w-[140px]">
              ...
              <div className="flex-1">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-xs text-gray-600 hover:text-gray-900 transition-colors block"
                >
                  @hadona.id
                </a>
              </div>
