  ...
  return (
    <div className="w-full" style={{ backgroundColor: '#ffffff' }}>
      <div className="grid gap-4 md:grid-cols-5 items-stretch">
        {/* Need Help Card - 20% */}
        <div className="rounded-lg bg-hadona-primary p-4 shadow-sm md:col-span-1">
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            <a 
              ...
              className="flex items-center gap-3 text-white transition-opacity hover:opacity-80 w-full"
              style={{ textDecoration: 'none' }}
            >
              <i className="bi bi-whatsapp" style={{ fontSize: '20px', flexShrink: 0 }}></i>
        ...
        <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm md:col-span-4">
          <h3 className="mb-4 text-base font-bold text-gray-900 text-center">Follow Us</h3>
          {/* Desktop: Horizontal layout */}
          <div className="hidden md:flex flex-wrap gap-4 justify-center items-start">
            {/* Instagram */}
            <a
